...
export default function TopCommonIssuesPage({ issues, isCloud, project, pageNumber }: Props) {
  ...
  return (
    <div className="report-page">
      ...
      <div className="issues-breakdown__title">Top Common Issues</div>
            ...
            <tr key={i}>
              <td>
                {s.hasMixedSeverity ? (
                  ...
                  <SeverityDot severity={s.severity} diameter={10} />
                )}
              </td>
              <td className="issues-summary-table__rule">{s.ruleName}</td>
              <td>
                <IssueTypeSmallIcon type={s.type} />
              </td>
